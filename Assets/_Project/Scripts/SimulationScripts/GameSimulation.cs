...
public struct GameSimulation : IGame
{
	...
	public GameSimulation(PlayerStatsSO[] playerStats, AssistStatsSO[] assistStats)
	{
		...
		for (int i = 0; i < _players.Length; i++)
		{
			...
			_players[i].attackNetwork = new AttackNetwork() { name = "", moveMaterial = "", attackSound = "", hurtEffect = "", impactSound = "", moveName = "" };
			_players[i].attackHurtNetwork = new AttackNetwork() { name = "", moveMaterial = "", attackSound = "", hurtEffect = "", impactSound = "", moveName = "" };
			...
			_players[i].shadow.projectile.attackNetwork = new AttackNetwork() { name = "", moveMaterial = "", attackSound = "", hurtEffect = "", impactSound = "", moveName = "" };
			...
			for (int j = 0; j < _players[i].projectiles.Length; j++)
			{
				...
				_players[i].projectiles[j].attackNetwork = new AttackNetwork() { name = "", moveMaterial = "", attackSound = "", hurtEffect = "", impactSound = "", moveName = "" };
